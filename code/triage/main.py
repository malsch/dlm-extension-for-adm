...
import os
os.chdir('/mnt/data/users/malte/donors-choose/donors-choose')
...
with open('donors-choose-config_v3.yaml', 'r') as fin:
...
visualize_chops(chopper, save_target = 'triage_output/timechop_v3.png')
...
experiment = MultiCoreExperiment(
    config = config,
    db_engine = db_engine,
    project_path = '/mnt/data/users/malte/donors-choose/donors-choose/ppath_v3',
    n_processes=32,
    n_db_processes=4,
    replace=False
    )
